...
<div class="navbar">
  ...
  <center><h3>Checking Out from Room <?php echo $room_no  ?></h3></center>
    ...
    ?>
    <h3>Days stayed in Hotel</h3>
    <?php 
        $row = mysqli_fetch_assoc($room_query_send);
        
            echo $row['check_in_date_time'];
            echo $row['room_no'];


    // $datediff = "SELECT DATEDIFF($row['check_in_date_time'], CURRENT_DATE()) from guests";
    // $qs = ($connection, $datediff);
    // echo $qs;
